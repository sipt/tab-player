...
import Window from "@src/pages/popup/Window";
import * as Dialog from "@radix-ui/react-dialog";
import { Cross2Icon } from "@radix-ui/react-icons";
import Toolbar from "@src/pages/popup/Toolbar";
import trashIcon from "@assets/img/trash.png";
import pinIcon from "@assets/img/pin.png";
import wandAndStarsIcon from "@assets/img/wand.and.stars.png";
    ...
    if (selectedIds.length === 0) {
      ...
      return (
        <div className="mt-[25px] flex justify-center gap-6 ">
          ...
          >
            <img className="w-6 h-7" src={trashIcon} />
          </button>
          <button
            className="w-16 h-16 shadow-sm rounded-lg text-slate-400 dark:bg-slate-800 ring-1 ring-slate-900/10 flex justify-center flex-wrap items-center"
            onClick={(e) => {
          ...
          >
            <img className="w-5 h-7" src={pinIcon} />
          </button>
        </div>
      );
    }
    ...
    <div>
      <div className="w-800 h-600 bg-gradient-to-b from-white to-white dark:from-gray-900 dark:to-slate-800 flex flex-col text-black dark:text-white">
        ...
        <div className="flex m-3">
          ...
          >
            <img className="w-6 h-6" src={wandAndStarsIcon} />
          </button>
        </div>
